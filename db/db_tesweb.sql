...
--
-- Host: localhost:3306
-- Generation Time: Oct 05, 2021 at 11:01 AM
...
(5, '2021_10_05_084921_create_table_provinces', 1),
(6, '2021_10_05_084949_create_table_cities', 1);
...
INSERT INTO `table_cities` (`id`, `province_id`, `type`, `city_name`, `postal_code`, `created_at`, `updated_at`) VALUES
...
--
-- Table structure for table `table_provinces`
--

CREATE TABLE `table_provinces` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `table_provinces`
--

INSERT INTO `table_provinces` (`id`, `province`, `created_at`, `updated_at`) VALUES
(1, 'Bali', NULL, NULL),
...
--
-- Indexes for table `table_provinces`
--
ALTER TABLE `table_provinces`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `table_provinces`
--
ALTER TABLE `table_provinces`
